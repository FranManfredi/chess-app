...
import java.util.List;
    ...
    public class ClassicGame {
        public Game CreateGame() {
            ...
            return new Game(board,SideColor.White, new ClassicWinCondition(), new ChessLegalMove());
        }

        private void CreateBlackQueenAndKing(List<PieceCoord> blackPieces, PieceFactory pieceFactory) {
            blackPieces.add(new PieceCoord(new Coordinate(4, 8), pieceFactory.clonePiece("queen", SideColor.Black)));
            blackPieces.add(new PieceCoord(new Coordinate(5, 8), pieceFactory.clonePiece("king", SideColor.Black)));
        }

        private void createBlackKnight(List<PieceCoord> blackPieces, PieceFactory pieceFactory) {
            blackPieces.add(new PieceCoord(new Coordinate(2, 8), pieceFactory.clonePiece("knight", SideColor.Black)));
            blackPieces.add(new PieceCoord(new Coordinate(7, 8), pieceFactory.clonePiece("knight", SideColor.Black)));
        }

        private void createBlackBishops(List<PieceCoord> blackPieces, PieceFactory pieceFactory) {
            blackPieces.add(new PieceCoord(new Coordinate(3, 8), pieceFactory.clonePiece("bishop", SideColor.Black)));
            blackPieces.add(new PieceCoord(new Coordinate(6, 8), pieceFactory.clonePiece("bishop", SideColor.Black)));
        }
        ...
        private void createBlackRooks(List<PieceCoord> blackPieces, PieceFactory pieceFactory) {
            ...
            blackPieces.add(new PieceCoord(new Coordinate(8, 8), pieceFactory.clonePiece("rook", SideColor.Black)));
        }
        ...
        private void createWhiteKingAndQueen(List<PieceCoord> whitePieces, PieceFactory pieceFactory) {
            ...
            whitePieces.add(new PieceCoord(new Coordinate(4, 1), pieceFactory.createPiece("queen", queenMovements, false, SideColor.White)));
            whitePieces.add(new PieceCoord(new Coordinate(5, 1), pieceFactory.createPiece("king", kingMovements, true, SideColor.White)));
        }

        private void createWhiteKnight(List<PieceCoord> whitePieces, PieceFactory pieceFactory) {
            ...
            whitePieces.add(new PieceCoord(new Coordinate(7, 1), pieceFactory.clonePiece("knight", SideColor.White)));
        }
        ...
        private void createWhiteBishops(List<PieceCoord> whitePieces, PieceFactory pieceFactory) {
            ...
            whitePieces.add(new PieceCoord(new Coordinate(3, 1), pieceFactory.createPiece("bishop", bishopMovements, false, SideColor.White)));
            whitePieces.add(new PieceCoord(new Coordinate(6, 1), pieceFactory.clonePiece("bishop", SideColor.White)));
        }
        ...
        private void createWhiteRooks(List<PieceCoord> whitePieces, PieceFactory pieceFactory) {
            ...
            whitePieces.add(new PieceCoord(new Coordinate(8, 1), pieceFactory.clonePiece("rook", SideColor.White)));
        }
        ...
        private void createWhitePawns(List<PieceCoord> whitePieces, PieceFactory pieceFactory, Integer quantity) {
            ...
            whitePieces.add(new PieceCoord(new Coordinate(1, 2), pieceFactory.createPiece("pawn", pawnMovements, pawnEatMoves, false, SideColor.White)));
            for (int i = 2; i <= quantity; i++) {
                whitePieces.add(new PieceCoord(new Coordinate(i, 2), pieceFactory.clonePiece("pawn", SideColor.White)));
            }
        }
    }
