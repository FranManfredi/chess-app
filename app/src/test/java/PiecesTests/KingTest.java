...
public class KingTest {
    ...
    void testValidVerticalMove() {
        MoveResult<Game, Boolean, SideColor> result = game.movePiece(new Coordinate(5, 1), new Coordinate(5, 2));
        assertEquals("Piece Moved", result.message());
    }

    @Test
    void testValidHorizontalMove() {
        MoveResult<Game, Boolean, SideColor> result = game.movePiece(new Coordinate(5, 1), new Coordinate(6, 1));
        assertEquals("Piece Moved", result.message());
    }

    @Test
    void testValidDiagonalMove() {
        MoveResult<Game, Boolean, SideColor> result = game.movePiece(new Coordinate(5, 1), new Coordinate(6, 2));
        assertEquals("Piece Moved", result.message());
    }

    @Test
    void testInvalidMove() {
        MoveResult<Game, Boolean, SideColor> result = game.movePiece(new Coordinate(5, 1), new Coordinate(7, 2));
